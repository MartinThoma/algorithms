...
if __name__ == '__main__':
    ...
    autokeras.constant.Constant.MAX_ITER_NUM = 10
    autokeras.constant.Constant.MAX_LAYERS = 4
    autokeras.constant.Constant.MAX_MODEL_NUM = 10
    autokeras.constant.Constant.SEARCH_MAX_ITER = 10
