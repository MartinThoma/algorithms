...
Copied from `21-keras-cnn-skip-connection`.
Check performance if we have more convolutional layers.


## Results

79.53% accuracy is to be beaten.

```
Epoch 00500: val_loss did not improve from 1.24426
16992/16992 [==============================] - 2s 92us/step
